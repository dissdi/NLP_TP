...
Default: Qwen/Qwen3-14B in 4-bit NF4 (~9GB VRAM, Colab Free T4 OK with bge-m3 unloaded).
`enable_thinking=False` is forced for Qwen3 to skip the internal CoT (2-3x latency saving).
